...
@Component({
  selector: 'app-learning-cards-symplified-systems',
  templateUrl: './learning-cards-symplified-systems.component.html',
  styleUrls: ['./learning-cards-symplified-systems.component.scss'],
  animations:[
    trigger('fade',[
        transition(':enter',[
...
export class LearningCardsSymplifiedSystemsComponent implements OnInit,DoCheck,OnDestroy {
  ...
  ngDoCheck(): void {
    this.cards=this.cards.filter(card=>card.key===KEYS.SIMPLIFIED_SYSTEMS);
