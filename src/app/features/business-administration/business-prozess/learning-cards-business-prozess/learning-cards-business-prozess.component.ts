...
@Component({
  selector: 'app-learning-cards-business-prozess',
  templateUrl: './learning-cards-business-prozess.component.html',
  styleUrls: ['./learning-cards-business-prozess.component.scss'],
  animations:[
    trigger('fade',[
        transition(':enter',[
...
export class LearningCardsBusinessProzessComponent implements OnInit,DoCheck,OnDestroy {
  ...
  ngDoCheck(): void {
    this.cards=this.cards.filter(card=>card.key===KEYS.BUSINESS_PROCESS);
