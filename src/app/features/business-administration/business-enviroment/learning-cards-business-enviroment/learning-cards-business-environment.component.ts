...
@Component({
  selector: 'app-learning-cards-business-enviroment',
  templateUrl: './learning-cards-business-environment.component.html',
  styleUrls: ['./learning-cards-business-environment.component.scss'],
  animations:[
    trigger('fade',[
        transition(':enter',[
...
export class LearningCardsBusinessEnvironmentComponent implements OnInit,DoCheck,OnDestroy {
  ...
  ngDoCheck(): void {
    this.cards=this.cards.filter(card=>card.key===KEYS.BUSINESS_ENVIRONMENT);
