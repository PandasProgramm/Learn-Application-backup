...
@Component({
  selector: 'app-learning-cars-it-safety',
  templateUrl: './learning-cars-it-safety.component.html',
  styleUrls: ['./learning-cars-it-safety.component.scss'],
  animations:[
    trigger('fade',[
        transition(':enter',[
...
export class LearningCarsItSafetyComponent implements OnInit,DoCheck,OnDestroy {
  ...
  ngDoCheck(): void {
    this.cards=this.cards.filter(card=>card.key===KEYS.IT_SAFETY);
