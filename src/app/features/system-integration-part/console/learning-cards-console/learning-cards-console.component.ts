...
@Component({
  selector: 'app-learning-cards-console',
  templateUrl: './learning-cards-console.component.html',
  styleUrls: ['./learning-cards-console.component.scss'],
  animations:[
    trigger('fade',[
        transition(':enter',[
...
export class LearningCardsConsoleComponent implements OnInit,DoCheck,OnDestroy {
  ...
  ngDoCheck(): void {
    this.cards=this.cards.filter(card=>card.key===KEYS.CONSOLE);
