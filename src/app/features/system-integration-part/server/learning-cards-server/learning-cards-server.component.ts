...
@Component({
  selector: 'app-learning-cards-server',
  templateUrl: './learning-cards-server.component.html',
  styleUrls: ['./learning-cards-server.component.scss'],
  animations:[
    trigger('fade',[
        transition(':enter',[
...
export class LearningCardsServerComponent implements OnInit,DoCheck,OnDestroy {
  ...
  ngDoCheck(): void {
    this.cards=this.cards.filter(card=>card.key===KEYS.SERVER);
