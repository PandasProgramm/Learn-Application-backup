...
@Component({
  selector: 'app-learning-cards-network-engineering',
  templateUrl: './learning-cards-network-engineering.component.html',
  styleUrls: ['./learning-cards-network-engineering.component.scss'],
  animations:[
    trigger('fade',[
        transition(':enter',[
...
export class LearningCardsNetworkEngineeringComponent implements OnInit,DoCheck,OnDestroy {
  ...
  ngDoCheck(): void {
    this.cards=this.cards.filter(card=>card.key===KEYS.NETWORK_ENGINEERING);
