...
@Component({
  selector: 'app-learning-cards-databases',
  templateUrl: './learning-cards-databases.component.html',
  styleUrls: ['./learning-cards-databases.component.scss'],
  animations:[
    trigger('fade',[
        transition(':enter',[
...
export class LearningCardsDatabasesComponent implements OnInit,DoCheck,OnDestroy {
  ...
  ngDoCheck(): void {
    this.cards=this.cards.filter(card=>card.key===KEYS.DATABASES);
