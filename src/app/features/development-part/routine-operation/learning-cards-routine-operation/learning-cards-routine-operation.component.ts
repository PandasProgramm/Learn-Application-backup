...
@Component({
  selector: 'app-learning-cards-routine-operation',
  templateUrl: './learning-cards-routine-operation.component.html',
  styleUrls: ['./learning-cards-routine-operation.component.scss'],
  animations:[
    trigger('fade',[
        transition(':enter',[
...
export class LearningCardsRoutineOperationComponent implements OnInit,DoCheck,OnDestroy {
  ...
  ngDoCheck(): void {
    this.cards=this.cards.filter(card=>card.key===KEYS.ROUTINE_OPERATIONS);
