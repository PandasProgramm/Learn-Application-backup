...
@Component({
  selector: 'app-learning-cards-software-production',
  templateUrl: './learning-cards-software-production.component.html',
  styleUrls: ['./learning-cards-software-production.component.scss'],
  animations:[
    trigger('fade',[
        transition(':enter',[
...
export class LearningCardsSoftwareProductionComponent implements OnInit,DoCheck,OnDestroy {
  ...
  ngDoCheck(): void {
    this.cards=this.cards.filter(card=>card.key===KEYS.PRODUCTION);
