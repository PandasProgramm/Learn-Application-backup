...
@Component({
  selector: 'app-learning-cards-testing',
  templateUrl: './learning-cards-testing.component.html',
  styleUrls: ['./learning-cards-testing.component.scss'],
  animations:[
    trigger('fade',[
        transition(':enter',[
...
export class LearningCardsTestingComponent implements OnInit,DoCheck,OnDestroy {
  ...
  ngDoCheck(): void {
    this.cards=this.cards.filter(card=>card.key===KEYS.TESTING);
