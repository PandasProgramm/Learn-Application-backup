...
@Component({
  selector: 'app-learning-cards-sql',
  templateUrl: './learning-cards-sql.component.html',
  styleUrls: ['./learning-cards-sql.component.scss'],
  animations:[
    trigger('fade',[
        transition(':enter',[
...
export class LearningCardsSqlComponent implements OnInit,DoCheck,OnDestroy {
  ...
  ngDoCheck(): void {
    this.cards=this.cards.filter(card=>card.key===KEYS.SQL);
