...
@Component({
  selector: 'app-learning-cards-web-app',
  templateUrl: './learning-cards-web-app.component.html',
  styleUrls: ['./learning-cards-web-app.component.scss'],
  animations:[
    trigger('fade',[
        transition(':enter',[
...
export class LearningCardsWebAppComponent implements OnInit,DoCheck,OnDestroy {
  ...
  ngDoCheck(): void {
    this.cards=this.cards.filter(card=>card.key===KEYS.WEB);
