...
@Component({
  selector: 'app-learning-cards-tools',
  templateUrl: './learning-cards-tools.component.html',
  styleUrls: ['./learning-cards-tools.component.scss'],
  animations:[
    trigger('fade',[
        transition(':enter',[
...
export class LearningCardsToolsComponent implements OnInit,DoCheck,OnDestroy {
  ...
  ngDoCheck(): void {
    this.cards=this.cards.filter(card=>card.key===KEYS.TOOLS);
