...
@Component({
  selector: 'app-learning-cards-java',
  templateUrl: './learning-cards-java.component.html',
  styleUrls: ['./learning-cards-java.component.scss'],
  animations:[
    trigger('fade',[
        transition(':enter',[
...
export class LearningCardsJavaComponent implements OnInit,DoCheck,OnDestroy {
  ...
  ngDoCheck(): void {
    this.cards=this.cards.filter(card=>card.key===KEYS.JAVA);
